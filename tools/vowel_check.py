...
VOWELS = [
    [1116, 6704, 26800, 25834, 12808, 7078, 6570, 2806],     # AH
    [1475, 17701, 26800, 13485, 4036, 3154, 3591, 1843],     # OH
    [26800, 14017, 10122, 11204, 5202, 4450, 4242, 2128],    # OO
    [1341, 12892, 26800, 19858, 14137, 8433, 6209, 2574],    # UH
    [2543, 26800, 20330, 6119, 13384, 23545, 18317, 5253],   # EH
    [26800, 6979, 1448, 1556, 4731, 14331, 20291, 9970],     # EE
]
